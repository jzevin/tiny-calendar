...
const assets = {
    html: '<divclass="tiny-calendar-wrap"><header><divclass="title">TinyCalendar</div><navclass="controls"><divclass="action"><buttonclass="btnbtn-prev">&lt;</button></div><divclass="action"><buttonclass="btnbtn-month">September</button></div><divclass="action"><buttonclass="btnbtn-year">2020</button></div><divclass="action"><buttonclass="btnbtn-next">&gt;</button></div></nav></header><sectionclass="pick-months"><ul><templateclass="pick-month-template"><li><div>Jan</div></li></template></ul></section><sectionclass="pick-years"><ul><templateclass="pick-year-template"><liclass="year">xxxx</li></template></ul></section><sectionclass="pick-days"><tableclass="cal-table"cellspacing="0"><theadclass="days"><tr><template><td><divclass="day-name">xxxx</div></td></template></tr></thead><tbody><tr><templateclass="pick-day-template"><td><divclass="day"><divclass="day-inner">xxxx</div></div></td></template></tr></tbody></table></section></div>',
    css: '.tiny-calendar-wrap{background-color:#ccc;padding:0.125em;border-radius:0.25em;overflow:hidden;box-shadow:8px8px7pxrgba(0,0,0,0.07);font-family:sans-serif;}.tiny-calendar-wrap*{box-sizing:border-box;}.tiny-calendar-wrapheader{height:64px;}.tiny-calendar-wrap.title{padding:0.35em0;background-color:#111;color:#eee;text-align:center;}.tiny-calendar-wrap.controls{display:flex;}.tiny-calendar-wrap.controls.action{display:flex;flex:11auto;background-color:#333;}.tiny-calendar-wrap.controls.action.btn{border:none;background-color:#333;flex:11auto;padding:0.5em;color:#eee;text-transform:uppercase;outline:none;font-size:100%;line-height:1.15;margin:0;cursor:pointer;}.tiny-calendar-wrap.controls.action.btn:hover{background-color:#111;}.tiny-calendar-wrap.day{display:flex;justify-content:center;align-items:center;padding:0.25em;color:#555;}.tiny-calendar-wrap.day.on.today{background-color:#fff;}.tiny-calendar-wrap.day.on{background-color:#eee;cursor:pointer;}.tiny-calendar-wrap.day.on:hover{background-color:#fff;}.tiny-calendar-wrap.day.off{background-color:#dedede;}.tiny-calendar-wrap.cal-table{width:100%;}.tiny-calendar-wrap.cal-table.days{background-color:#555;text-align:center;}.tiny-calendar-wrap.cal-table.day-name{padding:0.25em0.75em;color:#bbb;text-transform:uppercase;outline:1pxsolid#444;}.tiny-calendar-wrapsection.pick-months,.tiny-calendar-wrapsection.pick-years{height:0;overflow:hidden;transition:height120ms;}.tiny-calendar-wrapsection.pick-months.open,.tiny-calendar-wrapsection.pick-years.open{height:calc(100%-65px);}.tiny-calendar-wrapsection.pick-monthsul,.tiny-calendar-wrapsection.pick-yearsul{height:100%;display:flex;flex-wrap:wrap;list-style:none;padding:0;margin:0;}.tiny-calendar-wrapsection.pick-monthsulli,.tiny-calendar-wrapsection.pick-yearsulli{background-color:#dedede;padding:0.25em;flex:0025%;margin:0;display:flex;justify-content:center;align-items:center;outline:1pxsolid#bbb;text-transform:uppercase;transition:background-color250ms;cursor:pointer;}.tiny-calendar-wrapsection.pick-monthsulli:hover,.tiny-calendar-wrapsection.pick-yearsulli:hover{background-color:#fff;}'
};
